  ...
  return (
        <form className='bg-gray-200 p-5'>   
            ...
            <div className="relative mx-10 lg:mx-32">
                ...
                <input type="search" id="default-search" className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-yellow-500 focus:border-yellow-500" placeholder="Search Mentor..." required />
